...
function ApplicationPage() {
  ...
  return (
    ...
    <form className='mx-44'>
      <label>Zip Code<span style={{ color: 'red', fontSize:'1.5rem'}}>*</span>:
        <input className='border rounded border-black my-2 px-7 py-2 block'
          type="text" 
          value={zip}
    ...
    <form className='mx-44'>
      <label>Country<span style={{ color: 'red', fontSize:'1.5rem'}}>*</span>:
        <input className='border rounded border-black my-2 px-7 py-2 block'
          type="text" 
          value={country}
    ...
    <form className='mx-44'>
      <label>State/Province<span style={{ color: 'red', fontSize:'1.5rem'}}>*</span>:
    ...
    <form className='mx-44'>
      <label>Current Location<span style={{ color: 'red', fontSize:'1.5rem'}}>*</span>:
        <input className='border rounded border-black my-2 py-2 px-7 block'
          type="text" 
          value={current}
    ...
    <form className='mx-44 border'>
      <label>Gender<span style={{ color: 'red', fontSize:'1.5rem'}}>*</span> :
      <select className='block border'>
         <option value="Select">Select</option>
         <option value="Indeed">Male</option>
         <option value="Linkedin">Female</option>
    ...
    <form className='mx-44 border'>
      <label>Disability<span style={{ color: 'red', fontSize:'1.5rem'}}>*</span> :
      <select className='block border'>
         <option value="Select">Yes</option>
         <option value="Indeed">No</option>
      </select>
      <br/>
      </label>
    </form>
    ...
    <button
      className='bg-blue-600 hover:bg-blue-700 group relative px-9 py-1 overflow-hidden font-medium rounded-xl text-xl md:text-2xl shadow-2xl ml-40 my-8'
